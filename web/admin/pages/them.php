...
if(isset($_POST["txtthem"])){
	...
	if(empty($errors)){
		...
		$smmt=$conn->prepare("INSERT INTO `danhsach`(`name`, `price`, `intro`, `picture`, `created_at`) VALUES (:name, :price, :intro, :picture, :created_at)");
...
<form action="" method="POST" enctype="multipart/form-data">
	...
	<table>
		...
		<tr>
			<td colspan="2" align="center"><input type="submit" name="txtthem" value="add"></td>
		</tr>
